-- Replace placeholder teaser content for checklist-dfm-implantes (seed in 20260124000000 had only 3 truncated lines).
-- Source of truth matches scripts/update_dfm_resource.ts
UPDATE public.resources
SET
  content = $dfm$# Checklist DFM (Design for Manufacturing) para Implantes e Instrumentais
...
WHERE slug = 'checklist-dfm-implantes';
