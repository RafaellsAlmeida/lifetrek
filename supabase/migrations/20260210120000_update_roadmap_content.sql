-- Update the 'Roadmap de 90 Dias' content with the enhanced version based on user feedback.
UPDATE public.resources
SET content = $$# Roadmap de Nacionalização em 90 Dias: O Caminho Seguro
