# BLOG 24 — Execution Tracker (até 31/05/2026)

**Atualizado em:** 12/02/2026  
**Objetivo:** 24 posts com SEO forte, prontos para aprovação interna e scheduling.

## Baseline de SEO (12/02/2026)

- Posts auditados: 7
- Status: 1 `published`, 1 `draft`, 5 `pending_review`
- Passou em `seoTitleRange`: 3/7
- Passou em `seoDescriptionRange`: 0/7
- Passou em `keywordsMin3`: 0/7
- Passou em `featuredImage`: 1/7
- Passou em `sourcesMin4`: 0/7
- Passou em `referencesSection`: 0/7
- Passou em `faqSection`: 0/7
- Passou em `wordCountRange`: 6/7

## Legenda de Stage

- `scheduled`: pronto e com data definida
- `approved_to_schedule`: aprovado internamente e por stakeholder
- `stakeholder_review`: em revisão com stakeholder
- `draft_pending_internal`: draft pronto aguardando revisão interna
- `brief_ready`: pauta pronta para redação

## Tracker

| Slot | Data alvo | Tema | Fonte | Stage atual | SEO gate |
|---|---|---|---|---|---|
...
- `seo_title` 40-65 caracteres
- `seo_description` 140-160 caracteres
- 3+ keywords principais
- 1 keyword principal no H1 + introdução
...
- Segunda: selecionar 2 slots da semana
- Terça: fechar draft + SEO do slot A
- Quarta: revisão interna slot A, draft slot B
- Quinta: revisão interna slot B + stakeholder review
- Sexta: aplicar feedback + agendar o que foi aprovado
