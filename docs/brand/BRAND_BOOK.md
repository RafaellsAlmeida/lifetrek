...
10. [Brand Voice & Tone](#brand-voice--tone)
11. [Core Values](#core-values)
12. [Mission & Vision](#mission--vision)
13. [Logo Guidelines](#logo-guidelines)
14. [Photography Style](#photography-style)
15. [Video Guidelines](#video-guidelines)
16. [Modular Reference Guides](#modular-reference-guides)
...
To keep our brand documentation actionable and easy to maintain, we separate high-level brand identity from tactical implementation details.

### 💻 [Web & Development Guide (Quick Reference)](file:///Users/rafaelalmeida/lifetrek/docs/brand/BRAND_QUICK_REFERENCE.md)

Detailed CSS variables, technical UI patterns for developers, and spacing scales.

### 📱 [Social Media & LinkedIn Guidelines](file:///Users/rafaelalmeida/lifetrek/docs/brand/SOCIAL_MEDIA_GUIDELINES.md)

Visual templates (A, B, C, D) for carousels, post aesthetics, and social branding.

### 🎥 [Video Production Guidelines](file:///Users/rafaelalmeida/lifetrek/docs/brand/VIDEO_GUIDELINES.md)

Rules for cinematic industrial style, motion graphics, b-roll, and audio standards.

### 🏢 [Company Context & Technical Claims](file:///Users/rafaelalmeida/lifetrek/docs/brand/COMPANY_CONTEXT.md)

Background on facility, machinery, and pre-approved technical claims for accurate content generation.
