...
async function updateRefinedRoadmap() {
    const b64_1 = fs.readFileSync('/Users/rafaelalmeida/lifetrek/scripts/roadmap_b64_1_v3.txt', 'utf8').trim();
    const b64_2 = fs.readFileSync('/Users/rafaelalmeida/lifetrek/scripts/roadmap_b64_2_v3.txt', 'utf8').trim();
    ...
    const slides = [
        {
            "body": "Reduza riscos, melhore a qualidade e ganhe controle sobre seu fornecimento de dispositivos médicos.",
            "type": "hook",
    ...
    if (response.ok) {
        console.log("Success! Refined Roadmap carousel updated.");
    } else {
        console.log("Error:", response.status, await response.text());
    }
}

updateRefinedRoadmap();
