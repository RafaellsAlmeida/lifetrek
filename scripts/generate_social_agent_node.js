/**
 * Multi-Agent Creative Pipeline for Lifetrek Medical (Node.js JS Version)
 * 
 ...
 * 
 * Usage:
 *   node scripts/generate_social_agent_node.js "Precisão CNC em Implantes"
 *   node scripts/generate_social_agent_node.js "Precisão CNC" --dry-run
 */
...
Avalie a qualidade total.`;
    ...
    try {
        ...
        if (imageResponse.ok) {
            // Log success even if response is not JSON
