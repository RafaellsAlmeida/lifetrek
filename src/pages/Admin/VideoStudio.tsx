...
import type { EditorScene } from "@/components/video-studio/types";
...
export default function VideoStudio() {
  ...
  // Convert videoStudioPlan scenes to EditorScene format for the editor
  const editorScenes: EditorScene[] = useMemo(() => {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="editor" className="mt-6">
          <VideoStudioEditor
            ...
            projectTitle={videoStudioPlan.title}
          />
        </TabsContent>

        {/* Classic View Tab */}
        <TabsContent value="classic" className="mt-6 space-y-6">
          <Card>
            <CardHeader>
